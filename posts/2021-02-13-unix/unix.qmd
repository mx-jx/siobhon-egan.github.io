...
title: "Unix"
description: |
  Unix bash/zsh coding.
author: "Siobhon Egan"
date: "2021-02-13"
categories: [code, unix, bash]
---
...
[A brief guide to bash code from the Unix terminal]{.badge .badge-info}

## Get started

The following install instructions are courtesy of [Software carpentry lesson - the Unix Shell](http://swcarpentry.github.io/shell-novice/setup.html)
...
*Reference:* [How to Use Terminal on a Mac](How%20to%20Use%20Terminal%20on%20a%20Mac)
...
For advanced users, you may choose one of the following alternatives[^1]:

[^1]: Please note that commands in the Windows Subsystem for Linux (WSL) or Cygwin may differ slightly from those shown in the lesson or presented in the workshop.

-   [Install the Windows Subsystem for Linux](Install%20the%20Windows%20Subsystem%20for%20Linux)
