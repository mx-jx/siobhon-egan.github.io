...
-   Ulrik Lyngs - [RMarkdown workshop 2019 day 1 slide](https://ulyngs.github.io/rmarkdown-workshop-2019/slides/Day1.html#1)
...
[`vitae`](https://ropensci.org/blog/2019/01/10/vitae/), [Nick Strayer](https://github.com/nstrayer/cv) package based on pagedown [pagedown CVs](https://ulyngs.github.io/pagedown-cv/) [another example from pagedown](https://github.com/jienagu/Jiena_McLellan_CV/blob/master/Jiena_McLellan_CV.pdf) [another example from pagedown](https://landongetz.github.io/documents/CV.pdf)
...
Write your thesis with ease using [Thesisdown](https://github.com/ismayc/thesisdown) and [Oxforddown](https://ulyngs.github.io/oxforddown/). Some extra links [here](https://livefreeordichotomize.com/2018/09/14/one-year-to-dissertate/) and [here](https://github.com/LucyMcGowan).
