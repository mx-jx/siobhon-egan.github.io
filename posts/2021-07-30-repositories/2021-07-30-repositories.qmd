...
[Resources related to uploading sequences to repositories]{.badge .badge-info}
...
Details on [Uploading Files Using Command Line FTP Client](https://ena-docs.readthedocs.io/en/latest/submit/fileprep/upload.html?highlight=lftp#uploading-files-using-command-line-ftp-client)
...
> file extension must be `.tsv` or `.csv`
