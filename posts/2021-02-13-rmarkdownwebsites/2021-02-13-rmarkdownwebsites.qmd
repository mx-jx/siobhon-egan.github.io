---
title: "Websites using RMarkdown"
description: |
...
If using the `Simple R Markdown website` option to create a website then the default available themes options include: "cerulean", "cosmo", "cyborg", "darkly", "flatly", "journal", "lumen", "paper", "readable", "sandstone", "simplex", "slate", "spacelab", "superhero", "united", "yeti"...check them out [here](https://bootswatch.com/). Highlight options include: "default", "tango", "pygments", "kate", "monochrome", "espresso", "zenburn", "haddock", "breezedark", "textmate".
...
You can add footers to your webpages. Add a `footer.html` file to your directory and insert the following.
