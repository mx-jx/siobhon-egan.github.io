...
[Quick tutorial on using IQ-TREE webserver]{.badge .badge-info}
...
It has some fantastic documentation with detailed tutorials - see [here](http://www.iqtree.org/doc/). Current manual available [here](http://www.iqtree.org/doc/iqtree-doc.pdf).
...
![IQ-TREE webserver interface](iqtree-webserver.png)
