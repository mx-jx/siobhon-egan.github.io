...
author: "Siobhon Egan"
date: "2021-02-13"
categories: [rstudio rmarkdown, mapping]
---

🔗 Links to get to started for mapping in RStudio
...
Load mapping files Downloaded from GEODATA COAST 100K 2004 shapefiles available [here](https://data.gov.au/dataset/geodata-coast-100k-2004/resource/455ee5c6-2862-445e-8fbe-604476926b4c)

```r
Aus <-
  readOGR(dsn = "~/Documents/Programs/R/Maps/Rpackage_Geodata-coast/australia", layer = "cstauscd_r")
```
...
g2 <- g1 + geom_point(data = Sites, aes (
  x = Lon,
  y = Lat,
  colour = Locality,
  stroke = 1.5
