...
🔗 **Links** to some handy workshops/lessons I find

- [R Markdown Crash Course Zachary M. Smith](https://zsmith27.github.io/rmarkdown_crash-course/index.html)
...
You can add emojis into Rmarkdown html docs with the following code: `:bowling:` which will give you this 🎳 A full list of emoji short cuts available [here](https://www.webfx.com/tools/emoji-cheat-sheet/).
